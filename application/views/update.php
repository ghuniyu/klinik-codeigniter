            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-8 col-sm-8 col-lg-8 col-md-offset-2 col-sm-offset-2">
                    ...
                    <div class="signup-box">
                        <div class="logo">
							<img src="<?php echo base_url(); ?>assets/images/logo-c.svg" alt="" style="height: 40px;">
							<h3>Update Profile</h3>
						</div>
                        
                        <form action="<?php echo base_url(); ?>index.php/dashboard/do_update_profile" method="post" enctype="multipart/form-data">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input type="password" name="password" class="form-control" placeholder="Password" value="<?php echo $data->username ?>" >
                            ...
                            <button href="#" type="submit" class="btn btn-warning btn-block">Save</button>
